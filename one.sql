def lambda_handler(event, context):
    ...
    for acct_id in acct_ids_dict.keys():
        ...
        if audit_role_privileges_userinfo_parameter_list:
            flag = 3
            #parameter_list = audit_roles_list[0].keys()
            #Creates or update audit role privileges userinfo table
            ...
            #update_table(audit_roles_list, parameter_list, table_name='audit_role_privileges_userinfo')
