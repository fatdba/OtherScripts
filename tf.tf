...
locals {
  ...
  lambda_function_map = [
    {
      ...
      file_name     = "modules/drift_detection/drift_detection.zip"
  ...
  lambda_insights_layer_name = "arn:aws:lambda:${data.aws_region.current.name}:580247275435:layer:LambdaInsightsExtension:21"
}
